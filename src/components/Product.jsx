...
<div className='my-10 relative overflow-clip h-[30vh]'>
    ...
    <div  style={{backgroundImage: `url('${line}')`}} className={" grid gap-y-32 bg-cover "}>


{/* first */}
<div className='flex  justify-between md:mx-auto mx-2  gap-x-10 relative overflow-clip'>
...
<img src={singleLeaf} className='absolute right-0 -bottom-1/2'/>
...
<div className='my-auto '>
  <img src={third} className='h-48 '/> 
</div>
<img src={singleLeaf} className='absolute -bottom-1/2  -left-10 rotate-90 -translate-x-5 '/>
<img src={singleLeaf} className='absolute -bottom-1/4  -left-10 rotate-90  '/>
...
<div className=' my-auto '>
  <img src={fifth} className='h-48 '/> 
</div>
<img src={singleLeaf} className='absolute -bottom-1/2  -left-10 rotate-90'/>
<img src={singleLeaf} className='absolute -bottom-1/4  -left-10 rotate-90'/>
